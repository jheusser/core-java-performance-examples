 ...
 * @author peter.lawrey
 */
public class ThreadedAccountOneLockMain {
    public static void main(String... args) {
        ...
        for (int r = 0; r < 9; r++) {
            ...
            System.out.printf("Took an average of %,d ns to transfer money with a one global lock.%n", time / accountCount);
        }
    }

    private static void transfer(Object lock, Account from, Account to, int amount) {
        synchronized (lock) {
