 ...
 */
// run with: java  -server -XX:+TieredCompilation -XX:+AggressiveOpts spectralnorm 5500
...
public class spectralnorm {
  ...
  public static void main(String[] args) {
    ...
    double number = 0;
    for (int i = 0; i < 10; i++) {
      number = spectralnormGame(n);
    }
    long time = System.nanoTime() - start;
    System.out.printf("Took an average of %.3f seconds to run%n", time / 1e10);
